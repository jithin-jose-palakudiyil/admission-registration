...
//                    'category':{required:true, normalizer: function(value) { return $.trim(value);  } },
                    ...
                    'name_university':{required:true, normalizer: function(value) { return $.trim(value);  } },
                    'last_board_study':{required:true, normalizer: function(value) { return $.trim(value);  } },
                    'btech_register_no':{required:true, normalizer: function(value) { return $.trim(value);  } },
                    'btech_month_year_passing':{required:true, normalizer: function(value) { return $.trim(value);  } },
                    ...
                    'plus_two_mark_list' :   {required:true,fileType: { types: ["jpg", "jpeg", "png"] }, maxFileSize: { "unit": "MB",  "size": 2  }, }, 
                    'btech_mark_list' :   {required:true,fileType: { types: ["jpg", "jpeg", "png"] }, maxFileSize: { "unit": "MB",  "size": 2  }, }, 
                    'cgpa':{required:true,normalizer: function(value) { return $.trim(value);  },number:true },
                    'plus_two_percentage':{required:true,normalizer: function(value) { return $.trim(value);  },number:true },
                    'sslc_percentage':{required:true,normalizer: function(value) { return $.trim(value);  },number:true },
                    'gate_rank':{normalizer: function(value) { return $.trim(value);  },number:true },
