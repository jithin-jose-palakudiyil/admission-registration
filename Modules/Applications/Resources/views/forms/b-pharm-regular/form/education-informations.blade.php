...
<!--        <div class="col-md-4">
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>Total of Physics + Chemistry + Biology/Mathematics/Computer Science  : <span class="text-danger">*</span></label>
                <input type="text" name="pcm_total" class="form-control" placeholder="Total of Physics + Chemistry + Biology/Mathematics/Computer Science ">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>Physics + Chemistry + Biology/Maths/Computer Science Percentage : <span class="text-danger">*</span></label>
                <input type="text" name="pcm_percentage" class="form-control" placeholder="Physics + Chemistry + Biology/Mathematics/Computer Science Percentage">
            </div>
        </div>
    </div>
</div>