...
<form  class="form-horizontal" id="BtechRegularForm" method="post" enctype="multipart/form-data" action="{{route('b_pharm_regular_store',\Crypt::encryptString($decrypted_forms_college_id))}}" class="form-horizontal">
    @csrf
    <div id="basicwizard"> 
        @include('applications::forms.b-pharm-regular.partials.nav-item') 
        <div class="tab-content b-0 mb-0 pt-0 BasicwizardTabs">
            @include('applications::forms.b-pharm-regular.form.personal-informations')
            @include('applications::forms.b-pharm-regular.form.family-informations')
            @include('applications::forms.b-pharm-regular.form.education-informations')
            @include('applications::forms.b-pharm-regular.form.entrance-informations')
            @include('applications::forms.b-pharm-regular.form.finish')
...
@section('js') 
        ...
        <script src="{{asset('Modules/Applications/Resources/assets/js/b-pharm-regular-form.js')}}"></script>
