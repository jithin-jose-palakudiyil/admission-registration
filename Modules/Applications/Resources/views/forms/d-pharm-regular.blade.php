...
<form  class="form-horizontal" id="BtechRegularForm" method="post" enctype="multipart/form-data" action="{{route('d_pharm_regular_store',\Crypt::encryptString($decrypted_forms_college_id))}}" class="form-horizontal">
    @csrf
    <div id="basicwizard"> 
        @include('applications::forms.d-pharm-regular.partials.nav-item') 
        <div class="tab-content b-0 mb-0 pt-0 BasicwizardTabs">
            @include('applications::forms.d-pharm-regular.form.personal-informations')
            @include('applications::forms.d-pharm-regular.form.family-informations')
            @include('applications::forms.d-pharm-regular.form.education-informations')
            @include('applications::forms.d-pharm-regular.form.finish')
...
@section('js') 
        ...
        <script src="{{asset('Modules/Applications/Resources/assets/js/d-pharm-regular-form.js')}}"></script>
