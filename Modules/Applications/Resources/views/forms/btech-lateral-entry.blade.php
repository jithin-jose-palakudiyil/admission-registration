...
<form  class="form-horizontal" id="BtechRegularForm" method="post" enctype="multipart/form-data" action="{{route('btech_lateral_store',\Crypt::encryptString($decrypted_forms_college_id))}}" class="form-horizontal">
    @csrf
    <div id="basicwizard"> 
        @include('applications::forms.btech-lateral-entry.partials.nav-item') 
        <div class="tab-content b-0 mb-0 pt-0 BasicwizardTabs">
            @include('applications::forms.btech-lateral-entry.form.personal-informations')
            @include('applications::forms.btech-lateral-entry.form.family-informations')
            @include('applications::forms.btech-lateral-entry.form.education-informations') 
            @include('applications::forms.btech-lateral-entry.form.finish')
...
@section('js') 
        ...
        <script src="{{asset('Modules/Applications/Resources/assets/js/btech-lateral-entry-form.js')}}"></script>
