...
/* ************************************************************************** */ 
    ...
    if($('#board-datatable').length)
    {   
        
        var url=$('#board-datatable').attr('data-url');
        ...
        ({
            ...
            columns: [ 
                        ...
                        {
                            data: "board_type", sortable: true,  
                            render: function (data, type, full) 
                            { 
                                if(full.board_type=="1")  { return '<button type="button" class="btn btn-danger waves-effect waves-light">10th board</button>';  }
                                else if(full.board_type=="2")  { return '<button type="button" class="btn btn-success waves-effect waves-light">12th board</button>';  }
                                else if(full.board_type=="3")  { return '<button type="button" class="btn btn-primary waves-effect waves-light">Polytechnic board</button>';  }
                                else{ return null;}
                            } 
                        }, 
                        {
...
//            ignore: 'input[type=hidden], .select2-search__field', // ignore hidden fields
            ...
            { 
                ...
                if (element.attr("name") == "board_type" ){  $("#board_type_err").html(error); }
            ...
            rules: { 
                       ...
                       'board_type':{required:true, normalizer: function(value) { return $.trim(value);  } },
