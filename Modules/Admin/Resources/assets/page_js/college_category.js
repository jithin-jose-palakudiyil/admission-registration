var url_prefix ='college-category';
$(function() 
{  
...
/* ************************************************************************** */ 
    ...
    if($('#college-category-datatable').length)
    {   
        
        var url=$('#college-category-datatable').attr('data-url');
        $('#college-category-datatable').DataTable
        ({
            ...
            columns: [ 
                         ...
                         
                        {
                            ...
                            {   
                                ...
                                var assign_url=base_url+'/'+admin_prefix+'/assign-college-category/'+full.id+'';
...
/* ************************************************************************** */ 
    ...
    if($('#college_category_form').length)
    { 
        $("#name").keyup(function() {  $("#slug").val(generate_slug($("#name").val())); }); 
        $("#college_category_form").validate
        ({ 
            ignore: [],
