        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="name" name="name"  placeholder="Enter Name" value="{{$CollegeCategory['name']? $CollegeCategory['name']:old('name')}}" >
                    @if($errors->has('name'))
            ...
            <div class="col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug"  placeholder="Enter Slug" value="{{$CollegeCategory['slug']? $CollegeCategory['slug']:old('slug')}}" >
                    @if($errors->has('slug'))
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" data-toggle="select2" data-placeholder="status">
                     <option value="" > select </option> 
                        <option value="1"  @if(isset($CollegeCategory['status']) && $CollegeCategory['status']==1) selected @endif >Active</option>
                        <option value="0" @if(isset($CollegeCategory['status']) && $CollegeCategory['status']==0) selected @endif>InActive</option> 
                    </select>
                    <div id="status_err">
