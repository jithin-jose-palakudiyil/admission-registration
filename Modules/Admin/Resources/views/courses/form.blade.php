        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="name" name="name"  placeholder="Enter Name" value="{{$course['name']? $course['name']:old('name')}}" >
                    @if($errors->has('name'))
            ...
            <div class="col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug"  placeholder="Enter Slug" value="{{$course['slug']? $course['slug']:old('slug')}}" >
                    @if($errors->has('slug'))
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" data-toggle="select2" data-placeholder="status">
                     <option value="" > select </option> 
                        <option value="1"  @if(isset($course['status']) && $course['status']==1) selected @endif >Approved</option>
                        <option value="0" @if(isset($course['status']) && $course['status']==0) selected @endif>Unapproved</option> 
                    </select>
                    <div id="status_err">
...
@section('js')
    ...
    <script src="{{asset('Modules/Admin/Resources/assets/page_js/courses.js')}}"></script> 
@stop
