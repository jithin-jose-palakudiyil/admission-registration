...
<!-- <thead>
    <tr>
      ...
      <td style="font-weight: bold; font-size: 15px;width: 50%">Questions</td>
    ...
    <?php $i=1 ; foreach($PivotExamQA as $PivotExamQAkey => $PivotExamQAValue):
                            ...
                            ?>
                                ...
                                <?php if(isset($PivotExamQAValue->getQuestion) && $PivotExamQAValue->getQuestion->question):?>
                                    <p style="font-size: 13px"><span style="font-weight: 600">Q: {{$PivotExamQAkey + 1}}.  </span>{{$PivotExamQAValue->getQuestion->question}}</p>
                                 <?php endif;?>
                                </td></td>
                                    ...
                                    ?>
                                        <tr><td style="font-size: 15px; color: red">Not Answered</td></tr>
                                    <?php else:?>
                                        <tr><td><p style="font-size: 15px"><span style="font-weight: bold;">Given Answer : </span>{{$PivotExamQAValue->getAnswer->answer}}</p></td></tr>
                                    <?php endif; ?>
