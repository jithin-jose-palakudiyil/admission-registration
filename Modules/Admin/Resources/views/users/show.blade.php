                        ...
                        <div style="margin-top: 20px" class="row">
                            ...
                            <div id="plus_two_div">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <?php if( isset($CoursesCategory->slug) && $CoursesCategory->slug=='polytechnic-diploma-3-yrs'):?>
...
<script src="{{asset('Modules/Admin/Resources/assets/page_js/documents.js')}}" type="text/javascript"></script>
