...
@section('content')
       <div class="card"> 
            <div class="card-body">
                <table class="table datatable-basic" id="applications-datatable" data-url='{{route('colleges_applications_list')}}'>
                    <thead>
                        <tr>
                            <th>Name</th> 
                            <th>Email</th> 
...
<style>
    ...
    <script src="{{asset('Modules/Colleges/Resources/assets/js/applications.js')}}"></script>    
@stop
