                ...
                <div class="clg">
                    <div class="table-responsive">
                        <table class="table-sm">
                            ...
                            <tr>
                                <td><div class="si-no">12.</div> Category</td>
                            ...
                            <tr>
                                <td><div class="si-no">20.</div> Name of University</td>
                                <td>{{(isset($application->name_university) & $application->name_university !=null) ? $application->name_university : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">21.</div> Btech Stream</td>
                            ...
                            <tr>
                                ...
                                <td>{{(isset($application->btech_register_no) & $application->btech_register_no !=null) ? $application->btech_register_no : ""}}</td>
                            </tr>
                             <tr>
                                <td><div class="si-no">21(b).</div> Month & Year of passing</td>
                                <td>{{(isset($application->btech_month_year_passing) & $application->btech_month_year_passing !=null) ? $application->btech_month_year_passing : ""}}</td>
                            </tr>
                            <tr>
                                <td><div class="si-no">21(c).</div> CGPA</td>
                                <td>{{(isset($application->cgpa) & $application->cgpa !=null) ? $application->cgpa : ""}}</td>
                            </tr>
                            <tr>
                                <td><div class="si-no">22.</div> Plus2 Percentage</td>
                                <td>{{(isset($application->plus_two_percentage) & $application->plus_two_percentage !=null) ? $application->plus_two_percentage : ""}}</td>
                            </tr> 
                            <tr>
                                <td><div class="si-no">23.</div> SSLC Percentage</td>
                                <td>{{(isset($application->sslc_percentage) & $application->sslc_percentage !=null) ? $application->sslc_percentage : ""}}</td>
                            </tr> 
                            <tr>
                                <td><div class="si-no">24.</div> Gate Qualified</td>
                                <td>{{(isset($application->gate_qualified) & $application->gate_qualified !=null) ? $application->gate_qualified : ""}}</td>
                            </tr>       
                            <tr>
                                <td><div class="si-no">24(a).</div> Rank</td>
                                <td>{{(isset($application->gate_rank) & $application->gate_rank !=null) ? $application->gate_rank : ""}}</td>
                            </tr>
                            <tr>
                                <td><div class="si-no">25.</div> Quota</td>
...
<!--                                        </tr>
                    ...
                    <div class="diclaration-area" style="padding: 0px !important;padding-top: 10px !important">
                        <div class="all-text">
                            ...
                            <div class="diclaration-form">
                                <div class="site">
                                    <p><div class="name-place-attr">Rank</div> :</p>
                    ...
                    <div class="diclaration-area" style="padding: 0px !important;padding-top: 15px !important">
                        <div class="all-text">
