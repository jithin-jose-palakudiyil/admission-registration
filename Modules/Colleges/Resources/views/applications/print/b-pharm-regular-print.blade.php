                            ...
                            <tr>
                                <th colspan="2">
                                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between" class="table-header">
                                        ...
                                        <?php if(\Auth::guard(colleges_guard)->user()->id==9 && $application->hasForms->slug=='b-pharm-regular'): ?>
                                            <img src="/Logos/MgmLogo_B_pharm_regular_9.jpg" width="717">
                                        <?php elseif(\Auth::guard(colleges_guard)->user()->id==5 && $application->hasForms->slug=='b-pharm-regular'): ?>
                                            <img src="/Logos/MgmLogo_B_pharm_regular_5.jpg" width="717">
                                        <?php elseif(\Auth::guard(colleges_guard)->user()->id==7 && $application->hasForms->slug=='b-pharm-regular'): ?>
                                            <img src="/Logos/MgmLogo_B_pharm_regular_7.jpg" width="717">
                                        <?php elseif(\Auth::guard(colleges_guard)->user()->id==3 && $application->hasForms->slug=='b-pharm-regular'): ?>
                                    ...
                                    <h2 style="text-transform: uppercase;">APPLICATION FOR ADMISSION TO {{strtoupper($application->hasForms->name)}} DEGREE COURSE {{date('Y')}}-{{date('Y')+1}} <br/> UNDER Government / Management / NRI QUOTA</h2>
...
<!--                            <tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                <td colspan="2"><div class="si-no">24.</div> Details of Marks secured in the SSLC examination</td>
                            </tr>
                            <tr>
                                <td><div class="si-no">24(a).</div> Board of Study</td>
...
<!--                            <tr>
                            ...
                            <tr>
                                <td><div class="si-no">24(b).</div> Total % of marks</td>
