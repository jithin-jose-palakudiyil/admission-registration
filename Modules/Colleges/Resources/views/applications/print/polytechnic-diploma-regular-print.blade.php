                ...
                <div class="clg">
                    <div class="table-responsive">
                        <table class="table-sm">
                            ...
                            <tr>
                                <td colspan="2"><div class="si-no">21.</div> Details of Marks secured in the SSLC examination</td>
                            </tr>
                            <tr>
                                <td><div class="si-no">21(a).</div> Register No</td>
                                <td>{{(isset($application->sslc_register_no) & $application->sslc_register_no !=null) ? $application->sslc_register_no : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">21(b).</div> Month & Year of passing</td>
                                <td>{{(isset($application->sslc_month_year_passing) & $application->sslc_month_year_passing !=null) ? $application->sslc_month_year_passing : ""}}</td>
                                ...
                                <td colspan="2">
                                    <table class="sub-table">
                                        <tr class="text-center">
                                            <td style="width: 60%;" align="center">Subject</td>
                                            <td style="width: 40%;" align="center">Grade</td>
                                        </tr>
                                       
                                        <?php
                                        $Sslc_result = false;
                                        if(isset($application->id)):
                                            $Sslc = \Modules\Colleges\Entities\PivotApplicationsSslc::where('new_applications_id',$application->id)->get();;
                                            if($Sslc->isNotEmpty()):
                                                $Sslc_result = true;
                                                foreach ($Sslc as $Sslc_key => $Sslc_value): 
                                                ?>
                                                    <tr>
                                                        <td style="width: 60%;font-weight: 100!important" align="center">{{$Sslc_value->sslc_subject}}</td>
                                                        <td style="width: 20%;font-weight: 100!important" align="center">{{$Sslc_value->sslc_grade}}</td>
                                                    </tr>
                                                <?php
                                                endforeach;
                                            endif;
                            ...
                            <tr>
                                <td colspan="2" style="font-weight: 100!important"><strong style="font-weight: 700!important">Total Percentage : </strong>{{(isset($application->sslc_total_percentage) & $application->sslc_total_percentage !=null) ? $application->sslc_total_percentage : ""}}</td>
                            
                            
                                <!--<td style="font-weight: 100!important"><strong style="font-weight: 700!important">PCM Percentage : </strong> {{(isset($application->sslc_pcm_percentage) & $application->sslc_pcm_percentage !=null) ? $application->sslc_pcm_percentage : ""}}</td>-->
                            
                            </tr>
                            <tr>
                                <td colspan="2"><div class="si-no">22.</div> Details of Marks secured in the plus two examination</td>
                            </tr>
                            <tr>
                                <td><div class="si-no">22(a).</div> Register No</td>
                                <td>{{(isset($application->register_no) & $application->register_no !=null) ? $application->register_no : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">22(b).</div> Month & Year of passing</td>
...
<!--                            <tr>
                                <td colspan="2">
                                    <table class="sub-table">
                                        <tr class="text-center">
                                            <td style="width: 40%;;font-weight: 100!important" align="center">Subject</td>
                                            <td style="width: 20%;;font-weight: 100!important" align="center">Mark Obtained</td>
                                            <td style="width: 20%;;font-weight: 100!important" align="center">Maximum Marks</td>
                                            <td style="width: 20%;;font-weight: 100!important" align="center">Grade</td>
                                        </tr>
                                        ...
                                        if(isset($application->id)):
                                            ...
                                            if($PlusTwo->isNotEmpty()):
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="width: 40%;" align="center">{{$value->subject}}</td>
                                                        <td style="width: 20%;" align="center">{{$value->mark_obtained}}</td>
                                                        <td style="width: 20%;" align="center">{{$value->maximum_marks}}</td>
                                                        <td style="width: 20%;" align="center">{{$value->grade}}</td>
                                                    </tr>
                                                <?php
                                                endforeach;
                                            endif;
...
<!--                            <tr>
                                <td style="font-weight: 100!important"><strong style="font-weight: 700!important">Total PCM :</strong> {{(isset($application->pcm_total) & $application->pcm_total !=null) ? $application->pcm_total : ""}}</td>
                                <td ><strong>PCM Percentage : </strong>{{(isset($application->pcm_percentage) & $application->pcm_percentage !=null) ? $application->pcm_percentage : ""}}</td>
                            </tr>-->
...
<!--                                        </tr>
                    ...
                    <div class="diclaration-area" style="margin-top: 80px">
                        <div class="all-text">
