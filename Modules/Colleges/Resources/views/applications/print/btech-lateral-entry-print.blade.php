                ...
                <div class="clg">
                    <div class="table-responsive">
                        <table class="table-sm">
                            ...
                            <tr>
                                <td><div class="si-no">19.</div> Name of the Institution last studied(Diploma)</td>
                                <td>{{(isset($application->last_institution) & $application->last_institution !=null) ? $application->last_institution : ""}}</td>
                            
                            </tr>
                            
                            <tr>
                                <td><div class="si-no">19(a).</div> Register No</td>
                                <td>{{(isset($application->register_no) & $application->register_no !=null) ? $application->register_no : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">19(b).</div> Month & Year of passing</td>
                                <td>{{(isset($application->month_year_passing) & $application->month_year_passing !=null) ? $application->month_year_passing : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">19(c).</div> Diploma mark</td>
                                <td>{{(isset($application->diploma_mark) & $application->diploma_mark !=null) ? $application->diploma_mark : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">19(d).</div> Diploma Percentage</td>
                                <td>{{(isset($application->diploma_percentage) & $application->diploma_percentage !=null) ? $application->diploma_percentage : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">20.</div> Plus2 Percentage</td>
                                <td>{{(isset($application->plus2_mark) & $application->plus2_mark !=null) ? $application->plus2_mark : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">21.</div> SSLC Percentage</td>
                                <td>{{(isset($application->sslc_mark) & $application->sslc_mark !=null) ? $application->sslc_mark : ""}}</td>
                            
                            </tr>
                            <tr>
                                <td><div class="si-no">22.</div> Quota</td>
