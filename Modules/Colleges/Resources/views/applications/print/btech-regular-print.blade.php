                ...
                <div class="clg">
                    <div class="table-responsive">
                        <table class="table-sm">
                            <tr>
                                <th colspan="2">
                                    <div style="display: flex; flex-direction: row; align-items: center;" class="table-header">
                                        <div class="logo">
                                    ...
                                    <h2 style="text-transform: uppercase;">APPLICATION FOR ADMISSION TO {{strtoupper($application->hasForms->name)}} COURSE {{date('Y')}}-{{date('Y')+1}}<br/> UNDER Government / Management / NRI QUOTA</h2>
                            ...
                            <tr>
                                <td colspan="2"><div class="si-no">22.</div> Details of Entrance examination</td>
                            ...
                            <tr>
                                <td><div class="si-no">22(b).</div>Rank</td>
...
<!--                                        </tr>
                    ...
                    <div class="diclaration-area">
                        <div class="all-text">
                            <p class="responise">The above candidate is admitted Provisionally to …………………………………………………………. on  …………………………………………………………. under Government / Management / NRI Quota.</p>
