                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li {{(isset($active) && $active == 'dashboard') ? 'class=active' : ''}}>
                                <a href="{{route('colleges_dashboard')}}" {{(isset($active) && $active == 'dashboard') ? 'class=active' : ''}}>
                                    <i class="la la-dashboard"></i>
                                    <span> Dashboard </span>
                                </a>
                            </li>
                            <li {{(isset($active) && $active == 'applications') ? 'class=active' : ''}}>
                                <a href="{{route('colleges_applications_index')}}" {{(isset($active) && $active == 'applications') ? 'class=active' : ''}}>
