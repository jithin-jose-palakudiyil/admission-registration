    ...
    <div style="background-color: #fff;"  class="left-side-menu">
                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li >
                                <a href="{{ route('dashboard_web')}}"  {{(isset($active) && $active == 'dashboard') ? 'class=active' : ''}}> 
...
<li class="menu-title">Edit Registration Info</li>


                            <li>
                                <a href="{{ route('personal_info')}}"  {{(isset($active) && $active == 'personal-info') ? 'class=active' : ''}}> 
...
//                                            }
//                                            
//                                            $CoursesCategoryPluck = collect($CoursesCategory)->pluck('id');
                                            $CoursesCategoryPluck = $AssignUserCategoryCollegesCourses->pluck('courses_category_id')->unique();
                                        }
//dd($CoursesCategoryPluck);
                                    endif;
                                ?>

                            <li >
                                <a href="{{ route('courses_colleges_step', ['courses_category_array' => \Crypt::encryptString(json_encode($CoursesCategoryPluck))])}}"  {{(isset($active) && $active == 'categories') ? 'class=active' : ''}}> 
                                    <i class="las la-clipboard-list"></i>
                                    <!--<span class="badge badge-info badge-pill float-right">2</span>-->
                                    <span>College and Courses </span>
                                </a>
                            </li>

                            <li >
                                <a href="{{ route('courses_accademic_step')}}"  {{(isset($active) && $active == 'academics') ? 'class=active' : ''}}> 
...
<!--                            <li >
                                <a href="{{ route('document_info')}}"  {{(isset($active) && $active == 'documents') ? 'class=active' : ''}}> 
