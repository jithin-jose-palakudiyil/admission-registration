                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li >
                                <a href="{{ route('dashboard_web')}}" class="active"> 
                            ...
                            <li >
                                <a href="{{ route('personal_info')}}" class="active"> 
                            ...
                            <li >
                                <a href="{{ route('courses_colleges_step', ['courses_category_array' => \Crypt::encryptString(json_encode($CoursesCategoryPluck))])}}" class="active"> 
