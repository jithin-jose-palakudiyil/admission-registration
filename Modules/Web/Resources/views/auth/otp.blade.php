                        ...
                        <div class="card">
                            ...
                            <span class="logo-lg">
                                ...
                                <h5 class="auth-title"> Please Enter the OTP
                                        ...
                                        <p style="text-align: center; font-weight: 300;font-size: 13px; text-transform: none; margin-bottom: 0!important; margin-top:5px" for="mobile">OTP has been sent to <span style="color:#04c1a7; font-weight: bold">+91 {{Auth::guard(web_guard)->user()->mobile}}</span></p>
                                </h5>

                                <form action="{{route('OtpVerify')}}" method="post" id="otp_form"> 
                                    @csrf
...
@section('js')
<script src="{{asset('Modules/Web/Resources/assets/js/otp.js')}}" type="text/javascript"></script>
